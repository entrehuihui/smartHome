    ...
    <Modal :visible="true" title="修改设备型号" :footer="null" @cancel="close">
        <Form :model="formState" name="smartlogin" :labelCol="{ span: 0 }" :wrapperCol="{ span: 24 }" autocomplete="off"
            ...
            <FormItem name="groupName">
                <Input v-model:value="formState.groupName" size="large" placeholder="输入设备型号名称" :maxlength="30" />
            </FormItem>
            <FormItem name="groupDetails">
                <Textarea v-model:value="formState.groupDetails" size="large" placeholder="输入设备型号备注" :maxlength="300" />
            </FormItem>
